...
- [x] 9.0 Create Deployment Skills (3 skills)
...
- [x] 10.0 Validation & Cross-Linking
  ...
  - [x] 10.4 Update PLUGIN.md to register all 42 skills
  - [x] 10.5 Add `bknd-troubleshoot/SKILL.md` for common errors (per PRD Q&A)
