...
**Migration Required:** If you're upgrading from a previous version, see [PostgreSQL Package Migration Guide](../migration-guides/postgres-package-merge.md) for detailed migration steps.
...
**Performance Note:** Auto-joins load all columns from related tables by default. For optimal performance, use explicit `join` parameter with `select` to load only needed columns. See [Query System documentation](../reference/query-system.md) for more details.
...
See [SvelteKit integration guide](../how-to-guides/setup/integrations/sveltekit.md) for complete setup instructions.
...
See [Browser/SQLocal integration guide](../how-to-guides/setup/integrations/browser-sqlocal.md) for complete documentation.
...
- [PostgreSQL Package Migration Guide](../migration-guides/postgres-package-merge.md)
...
After upgrading:
1. Review the [PostgreSQL Package Migration Guide](../migration-guides/postgres-package-merge.md) if you're using PostgreSQL
...
- [Migration Guides](../migration-guides/postgres-package-merge.md)
