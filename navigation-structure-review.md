...
- **Problem**: Line 363 referenced `[Database Configuration](/data/seed-database)` which should have been `[Database Configuration](/data/seed-database)` (correct number of `../`)
...
- **Problem**: Line 359 referenced `[Database Configuration](/../architecture-and-concepts/database-setup)` but `database-setup.md` does not exist
- **Status**: ✅ **RESOLVED** - Changed to point to `[Choose Your Mode](/choose-your-mode)` which contains database configuration information
